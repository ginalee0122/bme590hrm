...
if __name__ == "__main__":
    ...
    tachycardia_threshold = float(input("Enter tachycardia threshold: ") or '100')
    bradycardia_threshold = float(input("Enter bradycardia threshold: ") or '60')
    ...
    BCnum = checkbrady(avgHR, tachycardia_threshold, bradycardia_threshold) 
